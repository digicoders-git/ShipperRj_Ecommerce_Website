...
<div class="row g-4">
    <div class="col-md-6">
        <div class="glass-card p-4 h-100">
            <h6 class="text-white fw-bold mb-4"><i class="bi bi-person-badge me-2 text-primary"></i>Personal Information</h6>
            <form action="{{ route('admin.profile.update') }}" method="POST">
                ...
                <div class="row g-3">
                    <div class="col-md-12">
                        ...
                        <input type="text" name="name" class="form-control glass-input" value="{{ $admin->name }}" required>
                    </div>
                    <div class="col-md-12">
                        <label class="form-label text-secondary small">Email Address</label>
                        <input type="email" name="email" class="form-control glass-input" value="{{ $admin->email }}" required>
                    </div>
                </div>
                ...
                <div class="row g-3">
                    <div class="col-md-12">
                        ...
                        <div class="position-relative">
                            <input type="password" name="current_password" class="form-control glass-input pe-5" placeholder="••••••••" required>
                            <button type="button" class="btn position-absolute top-50 end-0 translate-middle-y border-0 text-secondary pe-3 toggle-password-btn" style="z-index: 5;">
                                <i class="bi bi-eye"></i>
                            </button>
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="position-relative">
                            <input type="password" name="password" class="form-control glass-input pe-5" placeholder="••••••••" required>
                            <button type="button" class="btn position-absolute top-50 end-0 translate-middle-y border-0 text-secondary pe-3 toggle-password-btn" style="z-index: 5;">
                                <i class="bi bi-eye"></i>
                            </button>
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="position-relative">
                            <input type="password" name="password_confirmation" id="password_confirmation" class="form-control glass-input pe-5" placeholder="••••••••" required>
                            <button type="button" class="btn position-absolute top-50 end-0 translate-middle-y border-0 text-secondary pe-3 toggle-password-btn" style="z-index: 5;">
                                <i class="bi bi-eye"></i>
                            </button>
                        </div>
        ...
        <div class="glass-card p-4">
            ...
            <div class="d-flex align-items-center gap-3 p-3 rounded-3 bg-white bg-opacity-5">
                ...
                <div>
                    ...
                    <div class="text-secondary x-small">Last password change was 2 months ago. We recommend changing it every 6 months.</div>
                </div>
            </div>
        </div>
    </div>
