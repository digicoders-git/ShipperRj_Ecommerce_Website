    ...
    @section('content')
        <div class="checkout-luxury-wrapper">
                                ...
                                <div class="modal-body p-4 pt-0">
                                    <form id="addressForm" onsubmit="return handleAddressSave(event)">
                                            ...
                                            <div class="row g-2">
                                                <div class="col-12">
                                                    <div class="luxury-input-wrapper">
                                                        ...
                                                        <input type="text" name="name" class="luxury-input" placeholder="Full Name" required>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="luxury-input-wrapper">
                                                        <i class="bi bi-phone luxury-input-icon"></i>
                                                        <input type="tel" name="mobile" class="luxury-input" placeholder="Mobile Number" required pattern="[6789][0-9]{9}" minlength="10" maxlength="10" title="10 digits starting with 6,7,8 or 9">
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="luxury-input-wrapper">
                                                        <i class="bi bi-phone-vibrate luxury-input-icon"></i>
                                                        <input type="tel" name="alt_mobile" class="luxury-input" placeholder="Alt Mobile" pattern="[6789][0-9]{9}" minlength="10" maxlength="10" title="10 digits starting with 6, 7, 8 or 9">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row g-2">
                                                <div class="col-12">
                                                    <div class="luxury-input-wrapper">
                                                        ...
                                                        <textarea name="address_line" class="luxury-input pt-4" placeholder="House No, Building, Street, Area" style="height: 80px" required></textarea>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="luxury-input-wrapper">
                                                        <i class="bi bi-building luxury-input-icon"></i>
                                                        <input type="text" name="city" class="luxury-input" placeholder="City/District" required>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="luxury-input-wrapper">
                                                        <i class="bi bi-map luxury-input-icon"></i>
                                                        <input type="text" name="state" class="luxury-input" placeholder="State" required>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="luxury-input-wrapper">
                                                        <i class="bi bi-pin-map luxury-input-icon"></i>
                                                        <input type="text" name="pincode" class="luxury-input" placeholder="Pincode" required>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="luxury-input-wrapper">
                                                        <i class="bi bi-flag luxury-input-icon"></i>
                                                        <input type="text" name="landmark" class="luxury-input" placeholder="Landmark (Optional)">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="luxury-form-group mb-4">
                                            <label class="small fw-bold text-dark mb-3 ms-1 uppercase tracking-widest">Address Category</label>
                                            <div class="d-flex gap-3">
                                                <input type="radio" class="btn-check" name="type" id="typeHomeLux" value="Home" checked autocomplete="off">
                                                <label class="luxury-type-btn btn flex-grow-1" for="typeHomeLux">
                                                    <i class="bi bi-house-door me-2"></i> HOME
                                                </label>
                                                <input type="radio" class="btn-check" name="type" id="typeWorkLux" value="Work" autocomplete="off">
                                        ...
                                        <button type="submit" class="btn btn-luxury-primary w-100 py-3 rounded-pill fw-black shadow-premium border-0">
                ...
                @endpush
                    ...
                    <form id="checkoutForm" action="{{ route('checkout.order.process') }}" method="POST" onsubmit="return validateCheckout(event)">
                        @csrf
                        <input type="hidden" name="order_type" value="{{ $order_type }}">
                        <input type="hidden" name="buy_now" value="{{ $buy_now }}">
                        <input type="hidden" name="qty" value="{{ $qty }}">
                        <input type="hidden" name="address_id" id="selectedAddressId" value="{{ $addresses->where('is_default', 1)->first()->id ?? $addresses->first()->id ?? '' }}">
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="checkout-step-content active" id="step1-content">
                                    <div class="d-flex justify-content-between align-items-center mb-4">
                                        ...
                                        <button type="button" class="btn btn-outline-primary rounded-pill px-4" data-bs-toggle="modal" data-bs-target="#addAddressModal">
                                        ...
                                        <div class="row g-4" id="addressList">
                                            @forelse($addresses as $address)
                                                <div class="col-md-6">
                                                    <div class="luxury-address-card {{ $loop->first ? 'active' : '' }}" onclick="selectAddress('{{ $address->id }}', this)">
                                                        <div class="d-flex justify-content-between align-items-center mb-3">
                                                            <span class="luxury-badge">{{ $address->type }}</span>
                                                            @if($address->is_default)
                                                                <span class="luxury-status"><i class="bi bi-patch-check-fill me-1"></i> DEFAULT</span>
                                                            @endif
                                                        </div>
                                                        <h5 class="fw-black text-dark mb-2">{{ $address->name }}</h5>
                                                        <p class="text-secondary small mb-4 opacity-75 lh-base">{{ $address->address_line }}, {{ $address->landmark ? $address->landmark . ', ' : '' }}{{ $address->city }}, {{ $address->state }} - {{ $address->pincode }}</p>
                                            ...
                                            @empty
                                                <div class="col-12">
                                                    <div class="luxury-empty-state">
                                                        ...
                                                        <p class="text-muted small mb-4">Please add a shipping address to discover delivery methods and estimated times for your items.</p>
                                                        <button type="button" class="btn btn-luxury-primary px-5 py-3 rounded-pill fw-black" data-bs-toggle="modal" data-bs-target="#addAddressModal">
                                    ...
                                    <div class="text-end mt-5">
                                        <button type="button" class="btn btn-primary bg-gradient-primary px-5 py-3 rounded-pill fw-black" onclick="goToStep(2)" {{ $addresses->isEmpty() ? 'disabled' : '' }}>
                                ...
                                <div class="checkout-step-content" id="step2-content">
                                            ...
                                            @foreach($items as $item)
                                                <div class="p-4 border-bottom last-child-border-0">
                                                    <div class="d-flex gap-4">
                                                        <div class="product-img rounded-3 border overflow-hidden" style="width: 100px; height: 100px; flex-shrink: 0;">
                                                            <img src="{{ $item['image'] ? asset($item['image']) : 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?q=80&w=200' }}" class="w-100 h-100 object-fit-contain p-2">
                                                        </div>
                                                        <div class="flex-grow-1">
                                                            <h6 class="fw-black text-dark mb-1">{{ $item['name'] }}</h6>
                                                            <div class="d-flex align-items-center gap-3 mb-2">
                                                                <span class="fw-black text-primary">₹{{ number_format($item['price']) }}</span>
                                                                <span class="text-muted small">Qty: {{ $item['qty'] }}</span>
                                                            </div>
                                                            <div class="d-flex gap-2 flex-wrap">
                                                                <div class="xx-small text-secondary fw-bold uppercase px-2 py-1 bg-light d-inline-block rounded-pill">
                                                                    DELIVERY IN 3-5 DAYS
                                                                </div>
                                                                @if($item['min_qty'] > 1)
                                                                    <div class="xx-small text-danger fw-bold uppercase px-2 py-1 bg-danger bg-opacity-10 d-inline-block rounded-pill">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mt-5">
                                        <button type="button" class="btn btn-link text-dark text-decoration-none fw-bold" onclick="goToStep(1)">
                                            <i class="bi bi-arrow-left me-2"></i> BACK TO ADDRESS
                                        </button>
                                        <button type="button" class="btn btn-primary bg-gradient-primary px-5 py-3 rounded-pill fw-black" onclick="goToStep(3)">
                                    ...
                                    <div class="row g-4">
                                        <div class="col-md-6">
                                            <div class="payment-card p-4 rounded-4 border" onclick="selectPayment('cod', this)">
                                                ...
                                                @endphp
                                                <p class="text-secondary small mb-3 lh-sm">Pay <b class="text-dark">₹{{ number_format($base_advance + $cod_shipping) }}</b> now and rest <b class="text-dark">₹{{ number_format($total - $base_advance) }}</b> on delivery.</p>
                                                <div class="d-flex align-items-center gap-2">
                            ...
                            <div class="col-lg-4">
                                ...
                                <div id="priceSummaryCard" class="card border-0 shadow-premium rounded-5 price-details-card position-sticky overflow-hidden" style="top: 100px;">
                                    ...
                                    <div class="card-body p-4 pt-4">
                                        ...
                                        <div class="d-flex justify-content-between mb-3 align-items-center">
                                            <span class="text-muted fw-medium" id="shippingMethodLabel">COD Shipping Charges</span>
                                            <span class="text-dark fw-bold" id="shippingDisplay">₹{{ number_format($cod_shipping) }}</span>
                                        </div>
                                        ...
                                        <div class="d-flex justify-content-between align-items-baseline mb-2">
                                            ...
                                            <div class="text-end">
                                                <h4 class="fw-black text-primary mb-0">₹<span id="grandTotalDisplay">{{ number_format($total + $cod_shipping) }}</span></h4>
                                        ...
                                        <div class="p-3 rounded-4 bg-primary bg-opacity-5 border border-primary border-opacity-10 mt-3 d-flex justify-content-between align-items-center">
                                            <div>
                                                <div class="xx-small text-primary fw-black uppercase tracking-widest mb-1" id="payableNowLabel">Payable Now (Security Advance)</div>
                                                <div class="x-small text-dark fw-bold opacity-75 lh-sm">Total Payable Amount</div>
                                            </div>
                                            <div class="text-end">
                                                <h5 class="fw-black text-dark mb-0">₹<span id="payableNowDisplay">{{ number_format($base_advance + $cod_shipping) }}</span></h5>
                                            </div>
                                        </div>
                                    </div>
                ...
                <script>
                    ...
                    let currentShipping = {{ $cod_shipping }};
                    ...
                    function updateGrandTotal() {
                        document.getElementById('shippingDisplay').innerText = '₹' + currentShipping.toLocaleString();
                        ...
                        document.getElementById('payableNowDisplay').innerText = Math.round(payableNow).toLocaleString();
                    }
