                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="row g-2">
                                                ...
                                                <div class="col-md-3">
                                                    <label class="form-label text-secondary x-small fw-bold">ONLINE SHIPPING</label>
                                                    <input type="number" name="online_shipping_charges"
                                                        class="form-control glass-input x-small"
                                                        value="{{ $product->online_shipping_charges }}" placeholder="Leave blank for global default">
                                                    <div class="xx-small text-secondary mt-1">Leave blank for global default</div>
                                                </div>
                                                <div class="col-md-3">
                                                    <label class="form-label text-secondary x-small fw-bold">COD SHIPPING</label>
                                                    <input type="number" name="cod_shipping_charges"
                                                        class="form-control glass-input x-small"
                                                        value="{{ $product->cod_shipping_charges }}" placeholder="Leave blank for global default">
                                                    <div class="xx-small text-secondary mt-1">Leave blank for global default</div>
                                                </div>
                                                <div class="col-md-3">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <input type="number" name="cod_advance_percent"
                                                        class="form-control glass-input x-small"
                                                        value="{{ $product->cod_advance_percent }}" step="0.01" placeholder="Leave blank for global default">
                                                    <div class="xx-small text-secondary mt-1">Leave blank for global default</div>
                                                </div>
                                    ...
                                    <div class="col-lg-5">
                                                    ...
                                                    <div class="col-3">
                                                        <div class="ratio ratio-1x1 rounded-2 overflow-hidden border border-white border-opacity-5 cursor-pointer shadow-sm "
                                                                    ...
                                                                    @foreach($product->images as $gal)
                                                                        <div class="col-3">
                                                                            <div
                                                                                class="ratio ratio-1x1 rounded-2 overflow-hidden border border-white border-opacity-5 cursor-pointer shadow-sm"
                                                    ...
                                                    <div class="glass-card p-3 rounded-4 mb-3 border-0 position-relative overflow-hidden shadow-xl"
                                                        ...
                                                        <div class="row align-items-center position-relative z-1">
                                                            ...
                                                            <div class="col-6 col-md-3 border-start border-white border-opacity-10 ps-3">
                                                                ...
                                                                <p class="xx-small text-success uppercase fw-black mb-0 tracking-widest">Growth</p>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="glass-card p-2 px-3 rounded-4 border border-danger border-opacity-10">
                                                                ...
                                                                <p class="xx-small text-dark opacity-60 mb-0 font-italic">
                                                                    {{ $product->return_policy ?? '7-day policy' }}</p>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="glass-card p-2 px-3 rounded-4 border border-success border-opacity-10">
                                                                <h6 class="text-success xx-small fw-black mb-1 uppercase tracking-widest">WARRANTY
                                                                </h6>
                                                                <p class="xx-small text-dark opacity-60 mb-0 font-italic">
                                                                    {{ $product->warranty ?? 'Standard Warranty' }}</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="modal-footer border-0 p-3 bg-white bg-opacity-5 d-flex justify-content-end gap-2">
                                            ...
                                            <button type="button" class="btn btn-premium px-4 py-2 rounded-pill shadow-lg border-0"
                                                data-bs-toggle="modal" data-bs-target="#editProductModal{{ $product->id }}">Edit Product</button>
                                            @endif
                                        </div>
                                    </div>
                                </div>
        ...
        @endpush
                                    ...
                                    <div class="row g-3 text-white text-md-start">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="row g-2">
                                                ...
                                                <div class="col-md-3">
                                                    <label class="form-label text-secondary x-small fw-bold">SELLING</label>
                                                    <input type="number" name="selling_price" class="form-control glass-input x-small"
                                                        placeholder="0.00" required>
                                                </div>
                                                <div class="col-md-3">
                                                    <label class="form-label text-secondary x-small fw-bold">STOCK</label>
                                                ...
                                                <div class="col-md-3">
                                                    <label class="form-label text-secondary x-small fw-bold">ONLINE SHIPPING</label>
                                                    <input type="number" name="online_shipping_charges"
                                                        class="form-control glass-input x-small" placeholder="0.00">
                                                </div>
                                                <div class="col-md-3">
                                                    <label class="form-label text-secondary x-small fw-bold">COD SHIPPING</label>
                                                    <input type="number" name="cod_shipping_charges"
                                            ...
                                            <div class="row g-2">
                                                <div class="col-md-3">
                                                    ...
                                                    <div id="add-size-container">
                                                        <div class="position-relative mb-1">
                                                            <input type="text" name="size[]"
                                                                class="form-control glass-input x-small pe-4" placeholder="Add Size">
                                                            <i class="bi bi-plus-lg position-absolute end-0 top-50 translate-middle-y me-2 text-primary cursor-pointer"
                                                ...
                                                <div class="col-md-3 text-white text-md-start">
                                                    ...
                                                    <div id="add-color-container">
                                                        <div class="position-relative mb-1">
                                                            <input type="text" name="color[]"
                                                                class="form-control glass-input x-small pe-4" placeholder="Add Color">
                                                            <i class="bi bi-plus-lg position-absolute end-0 top-50 translate-middle-y me-2 text-primary cursor-pointer"
            ...
            @push('styles')
                <style>
                    ...
                    .modal-title, .modal-header .modal-title, h3, h4, h5, h6 {
                        color: #1f2937 !important;
                    }
                    .text-secondary {
                    ...
                    .text-white {
                        color: #ffffff !important; /* Keep utility class valid */
                    }
                    .thumbnail-preview {
