...
@section('admin_content')
                ...
                <div class="p-4 text-center bg-white border-bottom position-relative">
                    ...
                    <div class="mt-3">
                        <button type="button" class="btn btn-warning btn-sm rounded-pill px-4 fw-bold shadow-sm"
                            data-bs-toggle="modal" data-bs-target="#resetUserPasswordModal">
                            <i class="bi bi-key-fill me-1"></i> Reset User Password
                        </button>
                    </div>
                </div>
    ...
    <div class="modal fade" id="resetUserPasswordModal" tabindex="-1" aria-hidden="true">
            ...
            <div class="modal-content rounded-4 border-0 shadow-lg bg-white text-dark">
                ...
                <form action="{{ route('admin.users.reset-password', $user->id) }}" method="POST">
                    ...
                    <div class="modal-body p-4 text-start">
                        <p class="small text-muted mb-3">Set a new password for customer <strong>{{ $user->name }}</strong> ({{ $user->email ?? $user->mobile }}):</p>
