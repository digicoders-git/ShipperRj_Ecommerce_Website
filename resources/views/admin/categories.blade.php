                    ...
                    @foreach($categories as $category)
                        <tr class="border-bottom border-white border-opacity-5">
                            ...
                            <td>
                                ...
                                @else
                                    <div class="rounded-circle bg-primary bg-opacity-20 d-flex align-items-center justify-content-center text-white small fw-bold"
                                        style="width: 40px; height: 40px;">{{ substr($category->name, 0, 1) }}</div>
                                @endif
                            </td>
                            ...
                            <td>
                                @if($category->status == 1)
                                    <span
                                        class="badge bg-success bg-opacity-10 text-success border border-success border-opacity-25 px-3 py-2">Active</span>
                                @else
                                    <span
                                        class="badge bg-danger bg-opacity-10 text-danger border border-danger border-opacity-25 px-3 py-2">Inactive</span>
                                @endif
                            </td>
                            <td class="text-end">
                        ...
                        <form action="{{ route('admin.categories.update', $category->id) }}" method="POST"
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea name="description" class="form-control glass-input"
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    @if($category->image)
                                        <div
                                            class="mt-2 text-center border border-white border-opacity-10 rounded-4 p-2 bg-white bg-opacity-5 d-inline-block">
